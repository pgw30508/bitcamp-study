...
insert into ed_employee_type(et_id, type) values(13,'시간직');

select m.member_id, m.name, m.email, t.et_id, et.type from ed_member m inner join ed_teacher t
    on member_id = t.teacher_id inner join ed_employee_type et on t.et_id = et.et_id;
